...
INSERT INTO qr_definitions (qr_id, location, riddle, answer, next_clue, next_qr_id, next_qr_location, guaranteed_prize_id) VALUES
    ...
    ('QRP_02', 'Dustbin (6F)', 'I become larger every time something is taken away from me. What am I?', 'hole', 'Knowledge sleeps quietly here while deadlines scream outside.', 'QRP_12', 'Library (6F)', 'QR_02'),
    ('QRP_03', 'TV Area (5F)', 'The person who makes it has no use for it. The person who buys it never sees it. The person who uses it never knows it. What is it?', 'coffin', 'Find the place where forgotten office treasures vanish forever.', 'QRP_08', '6th Floor Random Cupboards', 'QR_03'),
    ('QRP_04', 'TV Area (6F)', 'I can fill a room without taking up any space. What am I?', 'light', 'Find the battlefield where caffeine defeats productivity.', 'QRP_05', 'Vending Machine / Bookshelf (5F)', 'QR_04'),
    ('QRP_05', 'Vending Machine / Bookshelf (5F)', 'I shave every day, but my beard stays the same. Who am I?', 'barber', 'Find the place people mysteriously disappear to during long calls.', 'QRP_13', 'Outside — No Name Area', 'QR_05'),
    ('QRP_06', 'Wall of Glory (5F)', 'I have cities but no houses, forests but no trees, and rivers but no water. What am I?', 'map', 'Find the place where people pretend standing improves productivity.', 'QRP_14', 'Standing Desk #1', 'QR_06'),
    ('QRP_07', 'Wall of Glory (6F)', 'Feed me and I live. Give me water and I die. What am I?', 'fire', 'Find the unofficial office sleeping headquarters.', 'QRP_09', 'Washrooms Hidden Spot #1', 'QR_07'),
    ('QRP_08', '6th inside cupboard Floor Random', 'The more of me there is, the less you can see. What am I?', 'darkness', 'Find the glowing wall celebrating old victories.', 'QRP_06', 'Wall of Glory (5F)', 'QR_08'),
    ('QRP_09', 'Washrooms Hidden Spot #1', 'I''m always coming, but I never arrive. What am I?', 'tomorrow', 'Find the giant screen where meetings become background noise.', 'QRP_03', 'TV Area (5F)', 'QR_09'),
    ('QRP_10', 'Washrooms Hidden Spot #2', 'What can you hold in your left hand but never in your right?', 'your right elbow', 'Find the second standing kingdom of fake ergonomic discipline.', 'QRP_15', 'Standing Desk #2', 'QR_10'),
    ('QRP_11', 'Cafeteria', 'The more you leave behind, the more you take with you. What are they?', 'footsteps', 'Find the wall where office legends are permanently framed.', 'QRP_07', 'Wall of Glory (6F)', 'QR_11'),
    ('QRP_12', 'Library (6F)', 'I have branches, but no fruit, trunk, or leaves. What am I?', 'bank', 'Find the place that welcomes everyone before chaos starts daily.', 'QRP_01', 'Reception (6F)', 'QR_12'),
    ('QRP_13', 'Outside — No Name Area', 'What invention lets you look right through a wall?', 'window', 'Find the magical bin where failed printouts go to die.', 'QRP_02', 'Dustbin (6F)', 'QR_13'),
    ('QRP_14', 'Standing Desk #1', 'I have lakes with no water, mountains with no stone, and cities with no buildings. What am I?', 'map', 'Find the giant screen upstairs where cricket scores matter more than work.', 'QRP_04', 'TV Area (6F)', 'QR_14'),
    ('QRP_15', 'Standing Desk #2', 'What is seen in the middle of March and April that cannot be seen at the beginning or end of either month?', 'r', 'Find the hidden washroom escape route nobody admits using.', 'QRP_10', 'Washrooms Hidden Spot #2', 'QR_15')
